...
def stream_1():
    ...
    while True:
        ...
        roi3 = [(680, 370), (930, 350), (990, 410), (790, 440)]
        ...
        vehicles_in_roi1, vehicles_in_roi2, vehicles_in_roi3, vehicles_in_roi4, track_ids_list = roi_tracking(results, [roi1, roi2, roi3, roi4])
...
def roi_tracking(results, roi_list):
    ...
    # class_ids = results[0].classes.cuda().id
